...
#include <fstream>
#include <string>
#include "Sharma_Jyotirmay_2488983641_ECQ2.h"

using namespace std;

//Constructor Definition of array2D
...
//Constructor Definition for ComplexNumber
...
int main()
{
double cxmin=-2.18,cymin=-1.15,cxmax=1.15,cymax=1.09;

    int noofimg=28;
    for (int i=0;i<noofimg;i++){

    string fileName= "intermediate_file"+ std::to_string(i) +".pgm";
